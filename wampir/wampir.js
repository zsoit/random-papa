const random_images_array = [
    ...
    'jan (80).jpg', 'jan (81).jpg', 'jan (82).jpg', 'jan (83).jpg',

    'jan (1).png', 'jan (2).png', 'jan (3).png', 'jan (4).png', 'jan (5).png', 'jan (6).png', 'jan (7).png', 'jan (8).png', 'jan (9).png',

    'jan (10).png', 'jan (11).png', 'jan (12).png',
